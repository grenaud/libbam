...
int main (int argc, char *argv[]) {
    ...
    vector<bool> * flagSingleORFirst=new vector<bool>();
	...
	flagSingleORFirst->push_back( (!al.IsPaired() || al.IsFirstMate () ) );
	// if((!al.IsPaired() || al.IsFirstMate () ) ){
	//     cerr<<"PASS "<<al.Name<<" "<<al.AlignmentFlag<<endl;
	// }else{
	//     cerr<<"FAIL "<<al.Name<<" "<<al.AlignmentFlag<<endl;
	// }
	...
	if( flagSingleORFirst->at(randomUnsInt) ){
